...
- `integrations/` (django, rails, laravel-scout) is deleted; they depended on the retired SDKs. Use `algoliasearch-rails`, `algoliasearch-django`, or Laravel Scout's Algolia driver.
