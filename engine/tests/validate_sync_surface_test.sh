...
files = [
  ...
  "engine/docs2/pbv4-crawler-openapi.json",
...
main() {
  ...
  remove_line "$repo/.debbie.toml" '"engine/docs2/pbv4-crawler-openapi.json"'
  assert_red_arm "$repo" crawler_openapi_dropped 'engine/docs2/pbv4-crawler-openapi.json exactly once (found 0)'
  restore_and_assert_clean "$pristine" "$repo" .debbie.toml crawler_openapi_dropped

  duplicate_sync_file "$repo/.debbie.toml" "engine/docs2/pbv4-crawler-openapi.json"
  assert_red_arm "$repo" crawler_openapi_duplicated 'engine/docs2/pbv4-crawler-openapi.json exactly once (found 2)'
  restore_and_assert_clean "$pristine" "$repo" .debbie.toml crawler_openapi_duplicated
